    ...
    >
      ...
      >
        <Pressable
          ...
          accessibilityLabel="Araç seçici"
        ...
        >
          ...
          <View style={styles.heading}>
            <View>
              <Text style={styles.title}>Araçlarınız</Text>
          ...
          >
            {vehicles.map((vehicle) => {
              ...
              const color =
                getVehicleColorDefinition(vehicle.colorId)?.hexFallback ?? colors.paleAqua;
              const metadata = [vehicle.year, vehicle.plate].filter(Boolean).join(' · ');
              return (
                <Pressable
                  key={vehicle.id}
                ...
                >
                  ...
                  <View style={styles.vehicleText}>
                    ...
                    <Text numberOfLines={1} style={styles.meta}>
                      {metadata || getVehicleTaxonomySummary(vehicle)}
                    </Text>
                  </View>
                  {selected ? (
                    <Ionicons
