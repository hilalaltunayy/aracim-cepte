...
| Data deletion exists                          | In progress                  | TASK-008 DB-first idempotent tekli/toplu belge ve araç cascade silme, cleanup queue ve Storage reconciliation remote E2E geçti. Hesap silme backend E2E de mevcut; Android UI/retry ve retention/hukuk kabulü açık.                              |
